            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
              <Card>
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                  ...
                  <div className={`h-2 w-2 rounded-full ${isOnline ? 'bg-success' : 'bg-destructive'}`}></div>
                </CardHeader>
                <CardContent>
              ...
              <Card>
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                  ...
                  <div className={`h-2 w-2 rounded-full ${!pendingSync ? 'bg-success' : 'bg-warning'}`}></div>
                </CardHeader>
                <CardContent>
                ...
                <CardContent>
                  <div className="h-[200px] flex items-end space-x-1">
                    {metrics['page.load_time']?.map((metric, i) => (
                      <div
                        key={i}
                        className="flex-1 bg-primary rounded-t hover:bg-primary/90 transition-colors"
                        style={{
                ...
                <CardContent>
                  <div className="h-[200px] flex items-end space-x-1">
                    {metrics['api.response_time']?.map((metric, i) => (
                      <div
                        key={i}
                        className="flex-1 bg-success rounded-t hover:bg-success/90 transition-colors"
                        style={{
            ...
            <Card>
              ...
              <CardContent>
                <div className="h-[400px] flex items-end space-x-1">
                  {performanceData.map((data, i) => (
                    <div key={i} className="flex-1 flex space-x-px">
                      <div
                        className="w-1/3 bg-primary hover:bg-primary/90 transition-colors rounded-t"
                        style={{ height: `${data.cpu}%` }}
                        title={`CPU: ${data.cpu.toFixed(1)}%`}
                      ></div>
                      <div
                        className="w-1/3 bg-success hover:bg-success/90 transition-colors rounded-t"
                        style={{ height: `${data.memory}%` }}
                        title={`Memory: ${data.memory.toFixed(1)}%`}
                      ></div>
                      <div
                        className="w-1/3 bg-accent hover:bg-accent/90 transition-colors rounded-t"
                ...
                <div className="flex justify-between mt-4 text-sm">
                  ...
                  <div className="flex items-center">
                    <div className="h-3 w-3 bg-success rounded-sm mr-2"></div>
                    <span>Memory Usage</span>
                  </div>
                  <div className="flex items-center">
                    <div className="h-3 w-3 bg-accent rounded-sm mr-2"></div>
                ...
                <CardContent className="space-y-4">
                  <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="p-3 bg-muted rounded-md flex items-center">
                        <Wifi className={`h-4 w-4 mr-2 ${systemInfo.online ? 'text-success' : 'text-destructive'}`} />
              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="flex items-start p-3 bg-muted/50 rounded-md">
                    <div className="text-success mr-3">[INFO]</div>
                    <div>
                  ...
                  {!isOnline && (
                    <div className="flex items-start p-3 bg-muted/50 rounded-md">
                      <div className="text-warning mr-3">[WARN]</div>
                      <div>
                  ...
                  {pendingSync && (
                    <div className="flex items-start p-3 bg-muted/50 rounded-md">
                      <div className="text-info mr-3">[SYNC]</div>
                      <div>
